      ...
      <ul className="mx-auto grid min-h-14 max-w-lg grid-cols-5">
        <li className="flex min-w-0">
          <button
            type="button"
            disabled
            aria-label="Inicio, no disponible"
          ...
          >
            <House size={18} className="sm:h-5 sm:w-5" aria-hidden="true" />
            <span className="max-w-full truncate">Inicio</span>
          </button>
        </li>
        ...
        <li className="flex min-w-0">
          <button
            type="button"
            disabled
            aria-label="Estudiantes, no disponible"
            className="flex min-h-14 w-full cursor-not-allowed flex-col items-center justify-center gap-0.5 px-0.5 text-[9px] font-semibold leading-tight text-gray-400 min-[360px]:text-[10px] sm:text-xs"
          >
            <GraduationCap size={18} className="sm:h-5 sm:w-5" aria-hidden="true" />
            <span className="max-w-full truncate">Estudiantes</span>
          </button>
        </li>
        ...
        <li className="flex min-w-0">
          <button
            type="button"
            disabled
            aria-label="Más, no disponible"
            className="flex min-h-14 w-full cursor-not-allowed flex-col items-center justify-center gap-0.5 px-0.5 text-[9px] font-semibold leading-tight text-gray-400 min-[360px]:text-[10px] sm:text-xs"
          >
            <Ellipsis size={18} className="sm:h-5 sm:w-5" aria-hidden="true" />
            <span>Más</span>
          </button>
        </li>
      </ul>
