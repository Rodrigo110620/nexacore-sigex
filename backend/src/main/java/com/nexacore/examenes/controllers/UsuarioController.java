 ...
 *   GET  /api/v1/usuarios        → listar usuarios paginados (B1)
...
public class UsuarioController {
    ...
    /**
     * Lista los usuarios registrados, paginados y ordenados por nombre ascendente.
     ...
     */
    @Operation(summary = "Listar usuarios", description = "Devuelve los usuarios registrados paginados y ordenados por nombre. Solo ADMIN.")
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping
